...
%\mynames{Liu/Chang, Chang Liu*,Liu/C.}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Chang Liu}

  \makefield{\faEnvelope[regular]}{\href{mailto:chang.liu@mathematik.uni-goettiengen.de}{\texttt{chang.liu@mathematik.uni-goettiengen.de}}}
  
  \makefield{\faEnvelope[regular]}
  {\href{mailto:chang.liu03@stud.uni-goettingen.de}{\texttt{chang.liu03@stud.uni-goettingen.de}}}

  \makefield{\faEnvelope[regular]}
  {\href{mailto:liuch951229@gmail.com}{\texttt{liuch951229@gmail.com}}}
...
\makefield{\faFlag}{\texttt{Shandong, China}} 

\makefield{\faBirthdayCake}{\texttt{29.12.1995}}
