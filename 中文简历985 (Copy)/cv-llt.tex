...
\leftheader{%
  {\LARGE\bfseries\sffamily 刘畅}
  
  \makefield{\faFlag}{\texttt{籍贯：山东省潍坊市}} \makefield{\faBirthdayCake}{\texttt{出生年月：1995年12月}}
  
  \makefield{\faCertificate}{\texttt{政治面貌：中共党员}}
  \makefield{\faUser}{\texttt{民族：汉族}}

\makefield{\faPhone}{\texttt{+86 178 0103 5464 （微信同号）}}  
  
  
  \makefield{\faEnvelope[regular]}{\href{mailto:example@gmail.com}{\texttt{chang.liu@mathematik.uni-goettiengen.de}}}
  
%  \makefield{\faEnvelope[regular]}
%  {\href{mailto:example@gmail.com}{\texttt{chang.liu03@stud.uni-goettingen.de}}}

  \makefield{\faEnvelope[regular]}
  {\href{mailto:example@gmail.com}{\texttt{liuch951229@gmail.com}}}
